...
sem_23_24_1.addCourse(new Course("Döntési rendszerek ea", new CourseTime(3, 8, 0), "MO-001", "Pluhár András", KOZOS));
...
sem_23_24_1.addCourse(new Course("Döntési rendszerek gyak", new CourseTime(3, 10, 0, 45), "IR-001", "Homolya Viktor", KOZOS));
...
sem_23_24_1.addCourse(new Course("CAS szakmai gyak", new CourseTime(0, 7, 30, 4*60), "CAS", "", KRISTOF_MUNKA));
sem_23_24_1.addCourse(new Course("CAS szakmai gyak", new CourseTime(2, 7, 30, 9*60), "CAS", "", KRISTOF_MUNKA));
sem_23_24_1.addCourse(new Course("CAS szakmai gyak", new CourseTime(3, 12, 15, 4*60+30), "CAS", "", KRISTOF_MUNKA));
sem_23_24_1.addCourse(new Course("CAS szakmai gyak", new CourseTime(4, 7, 30, 9*60), "CAS", "", KRISTOF_MUNKA));
...
sem_23_24_1.addCourse(new Course("Korrepetálás (Vivi)", new CourseTime(3, 17, 0, 4*60), "TIK", "Kozma Kristóf", KRISTOF_MUNKA));
