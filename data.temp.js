...
// COURSES
sem_23_24_1.addCourse(new Course("LaTeX ea", new CourseTime(0, 14, 0, 45), "IR-223", "Virágh János", KRISTOF));
sem_23_24_1.addCourse(new Course("LaTeX gyak", new CourseTime(0, 15, 0, 45), "IR-223", "Virágh János", KRISTOF));
...
sem_23_24_1.addCourse(new Course("Előadói készségfejlesztés", undefined, "", "Ata", KRISTOF));

sem_23_24_1.addCourse(new Course("Döntési rendszerek ea", new CourseTime(3, 8, 0), "", "Pluhár András", KRISTOF));
sem_23_24_1.addCourse(new Course("Gazdinfó ea", new CourseTime(0, 10, 0), "", "Bánhelyi Balázs", K_TEMP));
sem_23_24_1.addCourse(new Course("Alkalmazásfejlesztés C# alapokon", new CourseTime(0, 10, 0), "", "Ruzsinszki Gábor", K_TEMP));

sem_23_24_1.addCourse(new Course("Köszi gyak", new CourseTime(1, 14, 0, 45), "", "Csendes Tibor", K_TEMP, { primary: true }));
sem_23_24_1.addCourse(new Course("Köszi gyak", new CourseTime(1, 15, 0, 45), "", "Homolya Viktor", K_TEMP));

sem_23_24_1.addCourse(new Course("Döntési rendszerek gyak", new CourseTime(0, 12, 0, 45), "", "London András", K_TEMP, { disabled: true }));
sem_23_24_1.addCourse(new Course("Döntési rendszerek gyak", new CourseTime(0, 13, 0, 45), "", "London András", K_TEMP, { disabled: true }));
sem_23_24_1.addCourse(new Course("Döntési rendszerek gyak", new CourseTime(3, 10, 0, 45), "", "Homolya Viktor", K_TEMP));
sem_23_24_1.addCourse(new Course("Döntési rendszerek gyak", new CourseTime(3, 11, 0, 45), "", "Homolya Viktor", K_TEMP, { primary: true }));
sem_23_24_1.addCourse(new Course("Döntési rendszerek gyak", new CourseTime(3, 14, 0, 45), "", "Homolya Viktor", K_TEMP));
sem_23_24_1.addCourse(new Course("Döntési rendszerek gyak", new CourseTime(3, 15, 0, 45), "", "Homolya Viktor", K_TEMP, { disabled: true }));

sem_23_24_1.addCourse(new Course("Gazdinfó gyak", new CourseTime(3, 8, 0, 45), "IR-224", "Szász Attila", K_TEMP));
sem_23_24_1.addCourse(new Course("Gazdinfó gyak", new CourseTime(3, 9, 0, 45), "IR-224", "Szász Attila", K_TEMP));
sem_23_24_1.addCourse(new Course("Gazdinfó gyak", new CourseTime(3, 10, 0, 45), "IR-224", "Szász Attila", K_TEMP, { primary: true }));
...
sem_23_24_1.addCourse(new Course("Bonya gyak", new CourseTime(3, 16, 0, 45), "", "Horváth Krisztián", TEMP, { primary: true }));
...
sem_23_24_1.addCourse(new Course("CAS szakmai gyak", new CourseTime(3, 12, 0, 4*60), "CAS", "", KRISTOF_MUNKA, { temporary: true }));
