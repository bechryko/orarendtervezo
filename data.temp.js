...
sem_23_24_1.addCourse(new Course("LaTeX ea", new CourseTime(0, 14, 0, 45), "", "Virágh János", KRISTOF));
...
//sem_23_24_1.addCourse(new Course("Köszi gyak", new CourseTime(1, 13, 0, 45), "", "Csendes Tibor", K_TEMP));
sem_23_24_1.addCourse(new Course("Köszi gyak", new CourseTime(1, 14, 0, 45), "", "Csendes Tibor", K_TEMP));
sem_23_24_1.addCourse(new Course("Köszi gyak", new CourseTime(1, 15, 0, 45), "", "Homolya Viktor", K_TEMP));
//sem_23_24_1.addCourse(new Course("Köszi gyak", new CourseTime(1, 16, 0, 45), "", "Homolya Viktor", K_TEMP));

sem_23_24_1.addCourse(new Course("Döntési rendszerek gyak", new CourseTime(0, 12, 0, 45), "", "London András", K_TEMP));
sem_23_24_1.addCourse(new Course("Döntési rendszerek gyak", new CourseTime(0, 13, 0, 45), "", "London András", K_TEMP));
sem_23_24_1.addCourse(new Course("Döntési rendszerek gyak", new CourseTime(3, 10, 0, 45), "", "Homolya Viktor", K_TEMP));
sem_23_24_1.addCourse(new Course("Döntési rendszerek gyak", new CourseTime(3, 11, 0, 45), "", "Homolya Viktor", K_TEMP));
sem_23_24_1.addCourse(new Course("Döntési rendszerek gyak", new CourseTime(3, 14, 0, 45), "", "Homolya Viktor", K_TEMP));
sem_23_24_1.addCourse(new Course("Döntési rendszerek gyak", new CourseTime(3, 15, 0, 45), "", "Homolya Viktor", K_TEMP));

sem_23_24_1.addCourse(new Course("Gazdinfó gyak", new CourseTime(3, 8, 0, 45), "", "Szász Attila", K_TEMP));
sem_23_24_1.addCourse(new Course("Gazdinfó gyak", new CourseTime(3, 9, 0, 45), "", "Szász Attila", K_TEMP));
sem_23_24_1.addCourse(new Course("Gazdinfó gyak", new CourseTime(3, 10, 0, 45), "", "Szász Attila", K_TEMP));

sem_23_24_1.addCourse(new Course("Bonya gyak", new CourseTime(0, 8, 0, 45), "", "Szlúka András", TEMP));
sem_23_24_1.addCourse(new Course("Bonya gyak", new CourseTime(0, 9, 0, 45), "", "Szlúka András", TEMP));
sem_23_24_1.addCourse(new Course("Bonya gyak", new CourseTime(0, 10, 0, 45), "", "Szlúka András", TEMP));
sem_23_24_1.addCourse(new Course("Bonya gyak", new CourseTime(0, 11, 0, 45), "", "Szlúka András", TEMP));
