...
const KOZOS = new CourseCategory("Klaudia, Kristóf és Levi órái", "forestgreen");
...
const KL_TEMP_GYAK = new CourseCategory("gyakorlat Kristófnak és Levinek (választani egyet)", "#6fe0e1", true);
...
sem_22_23_2.addCourse(new Course("Assembly ea", new CourseTime(1, 13, 0, 1), "", "", KRISTOF_LEVI, false, true));
...
sem_22_23_2.addCourse(new Course("Scala ea", new CourseTime(3, 14, 0, 1), "", "Szabiván", KL_PLUS_GYAK));
sem_22_23_2.addCourse(new Course("Scala gyak", new CourseTime(3, 18, 0), "", "Szabiván", KL_PLUS_GYAK));

sem_22_23_2.addCourse(new Course("Logika gyak", new CourseTime(3, 15, 0, 1), "", "Kozma Kristóf", KRISTOF_TEACHER));
sem_22_23_2.addCourse(new Course("Logika gyak", new CourseTime(3, 16, 0, 1), "", "Kozma Kristóf", KRISTOF_TEACHER));
sem_22_23_2.addCourse(new Course("Progalap gyak", new CourseTime(4, 10, 0, 3), "", "Goldman Júlia, Kozma Kristóf", KRISTOF_TEACHER));
sem_22_23_2.addCourse(new Course("Prog1 gyak", new CourseTime(0, 11, 0), "", "Goldman Júlia, Jász Judit, Kozma Kristóf", KRISTOF_TEACHER));
sem_22_23_2.addCourse(new Course("Prog1 korrep", new CourseTime(1, 13, 0, 5), "TIK", "Kozma Kristóf", KRISTOF_TEACHER));

sem_22_23_2.addCourse(new Course("Web tervezés gyak", new CourseTime(3, 14, 0, 1), "", "Szabó Katalin, Lengyel Levente, Rácz Fanni", LEVI_TEACHER));
sem_22_23_2.addCourse(new Course("Web tervezés gyak", new CourseTime(4, 13, 0, 1), "", "Csuvik Viktor, Lengyel Levente, Rácz Fanni", LEVI_TEACHER));
...
sem_22_23_2.addCourse(new Course("Fonya gyak", new CourseTime(2, 14, 0, 1), "", "Oláh Tamás", KL_TEMP_GYAK, true));
sem_22_23_2.addCourse(new Course("Fonya gyak", new CourseTime(2, 15, 0, 1), "", "Oláh Tamás", KL_TEMP_GYAK));
...
sem_22_23_2.addCourse(new Course("Alga2 gyak", new CourseTime(2, 19, 0, 1), "", "Kiss-Vetráb Mercedes", KRISTOF_LEVI));
...
sem_22_23_2.addCourse(new Course("Assembly gyak", new CourseTime(3, 11, 0, 1), "", "Kiss Ákos", KRISTOF_LEVI));
...
sem_22_23_2.addCourse(new Course("Digikép gyak", new CourseTime(3, 17, 0, 1), "", "Kardos Péter", KOZOS));
...
sem_22_23_2.addCourse(new Course("Infóbiztonság gyak", new CourseTime(0, 10, 0, 1), "", "Dombi József", KOZOS));
...
sem_22_23_2.addCourse(new Course("Oprendszerek gyak", new CourseTime(2, 18, 0, 1), "", "Nagy Dániel, Sötét Petra", KRISTOF_LEVI));
...
sem_22_23_2.addCourse(new Course("Prognyelvek gyak", new CourseTime(3, 13, 0, 1), "", "Horváth Ferenc", KOZOS));

sem_22_23_2.addCourse(new Course("Alkalmazásfejlesztés 1 ea", new CourseTime(2, 15, 0, 1), "", "Dr. Siket István", KRISTOF_LEVI));
